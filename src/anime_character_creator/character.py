...
class Outfit:
    ...
    # for (`../time_slider_katherina/style-anchors/katherina_grok/`) wears a
    ...
    "pointed": GarmentCut(
        fills=(
            (
                (-0.121, 1.318),
                [
                    ((-0.123, 1.301), (-0.115, 1.284)),
                    ((-0.081, 1.238), (-0.046, 1.192)),
                    ((-0.035, 1.192), (-0.023, 1.192)),
                    ((-0.010, 1.209), (0.006, 1.226)),
                    ((0.026, 1.212), (0.040, 1.186)),
                    ((0.049, 1.186), (0.058, 1.186)),
                    ((0.099, 1.244), (0.138, 1.301)),
                    ((0.138, 1.313), (0.132, 1.324)),
                    ((0.109, 1.329), (0.086, 1.336)),
                    ((0.009, 1.336), (-0.069, 1.336)),
                    ((-0.095, 1.332), (-0.121, 1.318)),
                ],
            ),
            (
                (-0.236, 1.405),
                [
                    ((-0.291, 1.341), (-0.317, 1.278)),
                    ((-0.340, 1.209), (-0.351, 1.140)),
                    ((-0.344, 1.120), (-0.334, 1.100)),
                    ((-0.292, 1.062), (-0.265, 1.025)),
                    ((-0.236, 0.992), (-0.207, 0.990)),
                    ((-0.196, 1.000), (-0.184, 1.002)),
                    ((-0.173, 1.033), (-0.161, 1.065)),
                    ((-0.104, 1.123), (-0.046, 1.169)),
                    ((-0.046, 1.186), (-0.046, 1.203)),
                    ((-0.118, 1.298), (-0.190, 1.393)),
                    ((-0.213, 1.409), (-0.236, 1.405)),
                ],
            ),
            (
                (0.225, 1.410),
                [
                    ((0.201, 1.396), (0.178, 1.370)),
                    ((0.113, 1.278), (0.058, 1.186)),
                    ((0.110, 1.120), (0.190, 1.059)),
                    ((0.207, 1.028), (0.225, 0.996)),
                    ((0.245, 0.980), (0.265, 0.979)),
                    ((0.282, 0.988), (0.299, 0.996)),
                    ((0.336, 1.042), (0.386, 1.088)),
                    ((0.399, 1.111), (0.397, 1.134)),
                    ((0.368, 1.232), (0.311, 1.330)),
                    ((0.285, 1.367), (0.248, 1.405)),
                    ((0.236, 1.410), (0.225, 1.410)),
                ],
            ),
        ),
    ),
...
_LAB_COAT_LAPEL_LEFT: Chain = (
    (-0.228, 2.221),
    [
        ((-0.242, 2.209), (-0.256, 2.198)),
        ((-0.308, 2.063), (-0.369, 1.928)),
        ((-0.481, 1.702), (-0.600, 1.476)),
        ((-0.511, 1.411), (-0.437, 1.353)),
        ((-0.507, 1.307), (-0.577, 1.284)),
        ((-0.598, 1.265), (-0.606, 1.246)),
        ((-0.533, 1.101), (-0.448, 0.957)),
        ((-0.372, 0.866), (-0.296, 0.800)),
        ((-0.285, 0.800), (-0.273, 0.800)),
        ((-0.265, 0.810), (-0.256, 0.819)),
        ((-0.259, 1.042), (-0.256, 1.265)),
        ((-0.251, 1.296), (-0.245, 1.327)),
        ((-0.233, 1.520), (-0.211, 1.699)),
        ((-0.208, 1.902), (-0.200, 2.105)),
        ((-0.210, 2.154), (-0.206, 2.202)),
        ((-0.217, 2.212), (-0.228, 2.221)),
    ],
)
...
_LAB_COAT_LAPEL_RIGHT: Chain = (
    (0.245, 2.254),
    [
        ((0.237, 2.247), (0.228, 2.240)),
        ((0.232, 2.196), (0.223, 2.151)),
        ((0.231, 1.911), (0.239, 1.671)),
        ((0.263, 1.448), (0.290, 1.171)),
        ((0.290, 1.001), (0.290, 0.832)),
        ((0.297, 0.816), (0.313, 0.800)),
        ((0.318, 0.800), (0.324, 0.800)),
        ((0.332, 0.810), (0.341, 0.806)),
        ((0.406, 0.873), (0.470, 0.945)),
        ((0.495, 0.988), (0.527, 1.032)),
        ((0.581, 1.139), (0.634, 1.246)),
        ((0.627, 1.265), (0.606, 1.284)),
        ((0.535, 1.309), (0.465, 1.353)),
        ((0.532, 1.411), (0.600, 1.448)),
        ((0.621, 1.462), (0.628, 1.476)),
        ((0.501, 1.718), (0.380, 1.960)),
        ((0.331, 2.079), (0.279, 2.198)),
        ((0.276, 2.214), (0.273, 2.230)),
        ((0.259, 2.242), (0.245, 2.254)),
    ],
)
...
def render_character(
    ...
    layers = [
        ...
        *under_arms,
        ...
        # is worn on the head goes over the hair and the fringe both. Drawn
        # last of the whole figure rather than sharing the scarf's exact slot,
